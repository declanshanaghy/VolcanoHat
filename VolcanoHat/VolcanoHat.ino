...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(60, PIN_LEDS, NEO_GRB + NEO_KHZ800);
...
void isrErupt() {
  // TODO: Debounce is probably needed here
  erupt = true;
}
...
void eruptLEDs() {
  // TODO: Wipe each segment individually
